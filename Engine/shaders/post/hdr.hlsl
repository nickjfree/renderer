...
*/
PS_Output_Simple PS_Log(PS_Input_Simple input)
{   
...
*/
PS_Output_Simple PS_Avg(PS_Input_Simple input)
{   
    PS_Output_Simple output = (PS_Output_Simple)0;
    float3  Color = 0.0f;
    float3 vSample = 0.0f;
...
*/
PS_Output_Simple PS_Adapt(PS_Input_Simple input)
{   
    PS_Output_Simple output = (PS_Output_Simple)0;
    //oColor = (light + 0.1);
    float OldLum = 0.0f;
...
/*
    tonemapping
*/
PS_Output_Simple PS_ToneMapping(PS_Input_Simple input)
{   
    PS_Output_Simple output = (PS_Output_Simple)0;
    //oColor = (light + 0.1);
    float3 vSample = 0.0f;
...
/*
    GaussBloom5x5
*/
PS_Output_Simple PS_GaussBloom5x5(PS_Input_Simple input)
{
    PS_Output_Simple output = (PS_Output_Simple)0;
    //oColor = (light + 0.1);
    float4 vSample = 0.0f;
