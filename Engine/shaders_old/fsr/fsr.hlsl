...
[numthreads(64, 1, 1)]
void CS_Main(uint3 LocalThreadId : SV_GroupThreadID, uint3 WorkGroupId : SV_GroupID, uint3 Dtid : SV_DispatchThreadID)
{
...
{   
    ...
    output.Color = InputTexture.Sample(gSam, ps_input.TexCoord);
    return output;
}
